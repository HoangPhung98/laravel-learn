...
<div class="container">
    <div id="content">
    <form action="{{route('chotdon')}}" method="post" class="beta-form-checkout">
        @csrf    
        <div class="row">
                <div class="col-sm-6">
                    <h4>Đặt hàng</h4>
                ...
                <div class="col-sm-6">
                    <div class="your-order">
                        ...
                        <div class="your-order-body" style="padding: 0px 10px">
                            <div class="your-order-item">
                                ...
                                <!--  one item	 -->
                                    <div class="media">
                                        <img width="25%" src="{{asset('image/product/'.$item['item']->image)}}" alt="" class="pull-left">
                    ...
                    <div class="text-center">
                        <button class="beta-btn primary" type="submit">Đặt hàng 
                        </button>
                    </div>
                    </div> <!-- .your-order -->
                </div>
