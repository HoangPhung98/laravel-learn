									...
									data-bgfitend="undefined" data-owidth="undefined" data-oheight="undefined">
												<div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover"
													 ...
													 style="background-color: rgba(0, 0, 0, 0); 
															...
															background-image: url('image/slide/{{$slide->image}}'); 
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<p class="pull-left">Found {{count($new_products)}} item</p>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('product',$new_product->id)}}"><img src="image/product/{{$new_product->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$new_product->name}}</p>
											<p class="single-item-price">
												@if ($new_product->promotion_price!=0)
												<span class="flash-del">{{number_format($new_product->unit_price)}}</span>
												<span class="flash-sale">{{number_format($new_product->promotion_price)}}</span>
												@else
						...
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">{{count($promotion_products)}} found</p>
								<div class="clearfix"></div>
							</div>
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('product',$promotion_product)}}"><img src="image/product/{{$promotion_product->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$promotion_product->name}}</p>
											<p class="single-item-price">
											<span class="flash-sale">{{number_format($promotion_product->promotion_price)}}</span>
											</p>
										</div>
										<div class="single-item-caption">
