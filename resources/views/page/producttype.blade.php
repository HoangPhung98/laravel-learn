            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="beta-products-list">
                        ...
                        <p class="pull-left">{{count($products_of_type)}} found</p>
                            <div class="clearfix"></div>
                        </div>

                        <div class="row">
                            @foreach ($products_of_type as $product_of_type)
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                    <a href="product.html"><img src="{{asset('image/product/'.$product_of_type->image)}}" alt="" height="250px"></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{$product_of_type->name}}</p>
                                        <p class="single-item-price">
                                            <span>{{$product_of_type->unit_price}}</span>
                                        </p>
                                    </div>
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="assets/dest/images/1.jpg" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
